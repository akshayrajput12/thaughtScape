...
import type { Database as ExtendedDatabase } from './database-types';

// Merge the original database types with our extended types
type Database = OriginalDatabase & ExtendedDatabase;
