...
function RevealImageList() {
  ...
  return (
    <div className="flex flex-col gap-1 rounded-sm bg-background/50 backdrop-blur-sm px-8 py-4">
      <h3 className="text-sm font-black uppercase text-muted-foreground">Our Community</h3>
